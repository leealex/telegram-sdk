 ...
 *
 * @property string $url An HTTP URL to be opened with user authorization data added to the query string when
 * the button is pressed. If the user refuses to provide authorization data, the original URL without information
 ...
 *
 * @property string $bot_username Optional. Username of a bot, which will be used for user authorization. See Setting up
 * a bot for more details. If not specified, the current bot's username will be assumed. The url's domain must be
